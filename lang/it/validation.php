...
return [
    ...
    */
    ...
    "are_you_sure_you_want_to_delete_member" => " Sei sicuro di voler rimuovere questo membro del team?",
    "are_you_sure_you_want_to_delete_team" => "Sei sicuro di voler eliminare questo team?",
    "are_you_sure_you_want_to_leave_team" => "Sei sicuro di voler lasciare questo team?",
    ...
    "country" => "Il campo :attribute non è un paese valido.",
    "create_team" => "Crea Team",
    "current_password" => "Password non valida.",
    "current_teams" => " Team correnti",
    ...
    "edit_team_member" => " Modifica membro Team",
    ...
    "if_you_delete_team_all_data_will_be_deleted" => "Se scegli di eliminare il team tutti i dati verranno permanentemente eliminati.",
    ...
    "leave_team" => " Esci dal team",
    "looks_like_you_are_not_part_of_team" => "Sembra che tu non faccia parte di nessun team!",
    ...
    "not_eligible_based_on_current_members_teams" => "Non sei idoneo a questo piano in base al numero attuale dei tuoi team / membri team.",
    ...
    "plan_allows_no_more_teams" => "Il tuo piano attuale non consente la creazione di altri team",
    "please_upgrade_to_add_more_members" => " Per favore aggiorna la tua sottoscrizione per aggiungere altri membri al team.",
    "please_upgrade_to_create_more_teams" => "Per favore aggiorna la tua sottoscrizione per creare nuovi team.",
    ...
    "remove_team_member" => "Rimuovi membro dal team",
    ...
    "slug_input_explanation" => "Questo slug è utilizzato per identificare il tuo team negli URL.",
    "starts_with" => ":Attribute deve iniziare con uno dei seguenti: :values",
    "state" => "Questo stato non è valido per la nazione specificata.",
    "string" => ":Attribute deve essere una stringa.",
    "team" => "Squadra",
    "team_billing" => "Fatturazione team",
    "team_members" => "Membri team",
    "team_name" => " Nome team",
    "team_name_was_updated" => " Il nome del tuo team è stato aggiornato!",
    "team_photo" => " Foto del team",
    "team_profile" => " Profilo del team",
    "team_settings" => "Impostazioni del team",
    "team_slug" => "Slug del team",
    "team_trial" => "Periodo di prova del team",
    "team_trial_will_expire_on" => "Il periodo di prova del team scadrà il :date.",
    "teams" => " Team",
    "teams_currently_trialing" => "Team attualmente in prova",
    ...
    "update_team_name" => "Aggiorna nome team",
    ...
    "user_already_invited_to_team" => "L'utente è già stato invitato ad unirsi al team.",
    "user_already_on_team" => "L'utente è già membro del team.",
    "user_doesnt_belong_to_team" => "L'utente non appartiene al team specificato.",
    "user_invited_to_join_team" => ":UserName ti ha invitato ad unirti al team!",
    "uuid" => ":Attribute deve essere un UUID valido.",
    "vat_id" => "Il numero di partita IVA non è valido.",
    "view_all_teams" => "Vedi tutti i team",
    "we_found_invitation_to_team" => "Abbiamo trovato il tuo invito al team :teamName!",
    "wheres_your_team" => "Dov'è il tuo team?",
    "you_have_been_invited_to_join_team" => "Sei stato invitato da unirti al team :teamName!",
    "you_have_x_invitations_remaining" => " Hai al momento :count invito/i rimasto/i.",
    "you_have_x_teams_remaining" => "Hai al momento :teamCount team rimasto/i.",
